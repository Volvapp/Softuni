...
public class KAT {
    public static void main(String[] args) throws IOException {
        ...
        ArrayDeque<Long> registrationPLateAsQueue = Arrays.stream(reader.readLine().split(", "))
                .map(Long::parseLong).collect(Collectors.toCollection(ArrayDeque::new));
        ...
        while (!registrationPLateAsQueue.isEmpty() && !carsAsStack.isEmpty()) {
            ...
            long currentNumberOfPlate = registrationPLateAsQueue.poll();


            long currNumberOfCars = carsAsStack.pop();
